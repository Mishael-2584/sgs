<nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
           ...
           <li class="#">
               <a href="{{route('lecturer-add-material')}}"><i class="fa fa-users"></i> <span class="nav-label">Add Students</span></a>
           </li>
           ...
           <li class="">
                <a href="{{route('lecturer-allresults')}}"><i class="fa fa-users"></i> <span class="nav-label">User management</span> </a>
           </li>
           @endif --
