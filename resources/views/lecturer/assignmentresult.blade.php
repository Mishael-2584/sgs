                ...
                <div class="col-sm-4">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active">
                            <strong>@isset($assignment_title)
                                <th><h2>{{$assignment_title->title}}</h2></th>  
                                @endisset</strong>
                        </li>
                    </ol>
                </div>
             ...
             <div class="table-responsive">
                 <table class="table table-striped table-bordered table-hover dataTables-example" >
                      ...
                      <tr class="gradeX">
                          ...
                          <td>
                            @php
                                echo(intval($student->assignment_type->assignment_out_of));
                            @endphp
                          </td>           
                          <td class="project-actions"><a href="{{ route('lecturer-assignment-grade', $student->id)}}"><i class="fa fa-arrow-right"></i>View</a></td>           
                      </tr>
                    @endforeach
