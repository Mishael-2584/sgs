                        ...
                        <div class="row">
                            <div class="col-lg-12">
                               <ul class="nav nav-tabs">
                                <li class="text-color"><a class="nav-link active" data-toggle="tab" href="#tab-1"><i class="fa fa-plus"></i> ADD RESULT</a></li>
                                <li><a class="text-color" data-toggle="tab" href="#tab-2"><i class="fa fa-address-book"></i> View Results</a></li>
                               </ul>
               ...
               <table class="table table-striped table-bordered table-hover dataTables-example" >
                    ...
                    @foreach ($scores as $score )
                        <tr class="gradeX">
                            ...
                            <td class="text-center">{{$score->total_grade}}</td>
