                        ...
                        <div class="row">
                            <div class="col-lg-12">
                               <ul class="nav nav-tabs">
                                <li><a class="nav-link" data-toggle="tab" href="#tab-1"><i class="fa fa-address-book"></i> View Results</a></li>
                               </ul>
                           <div class="tab-content">
                               <ul class="nav nav-tabs" id="onclik">
                                {{-- <li class="text-color"><a class="nav-link" data-toggle="tab" href="#tab-1"><i class="fa fa-plus"></i> ADD RESULT</a></li>
                                <li><a class="text-color clikk" data-toggle="tab" href="#tab-2"><i class="fa fa-address-book"></i> View Results</a></li> --}}
                               </ul>
                           <div class="tab-content">
